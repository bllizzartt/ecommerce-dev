  ...
  return (
    <div className="bg-slate-50">
        ...
        <MaxWidthWrapper className="pb-24 pt-10 lg:grid lg:grid-cols-3 sm:pb-32 lg:gap-x-0 xl:gap-x-8 lg:pt-24 xl:pt-32 lg:pb-52">
          <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
            <div className="relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start">
              ...
              mt-16 font-bold !leading-tight text-gray-900 text-5xl md:text-6xl 
              lg:text-7xl"
              >
                Your Image on a{" "}
              ...
              <p className="mt-8 text-lg lg:pr-10 max-w-prose text-center lg:text-left text-balance md:text-wrap">
                ...
                CaseCobra allows you toprotect your memories, not just your
                phone case.
              </p>

              <ul
                className="mt-8 space-y-2 text0left font-medium flex
      ...
      <section className="bg-slate-100 py-24">
        ...
        >
          <div
            className="flex flec-col lg:flex-row items-center gap-4
          sm:gap-6"
          >
            <h2
          ...
          >
            <div
              className="flex flex-auto flex-col gap-4 lg:pr-8 
            xl:pr-20"
            >
              <div className="flex gap-0.5 mv-2">
              ...
              <div className="text-lg leading-8">
                <p>
                  ...
                  yellow-ish color after absolute couple weeks. Love it."
                </p>
              </div>
      ...
      <section>
        <MaxWidthWrapper className="py-24">
          ...
          <div className="mx-auto max-w-6xl px-6 lg:px-8">
            <div className="relative flex flex-col items-cetner md:grid grid-cols-2 gap-40">
              <img
                src="/arrow.png"
              ...
              md:justify-self-end max-w-sm rounded-x1 bg-gray-900/5 ring-inset
